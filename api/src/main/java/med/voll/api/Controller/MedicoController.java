...
public class MedicoController {
    ...
    @GetMapping
    public ResponseEntity<Page<DadosListagemMedico>> listarMedico(@PageableDefault(size = 10, page = 0,sort = {"nome"}) Pageable paginacao){
...
//    }
    ...
    @GetMapping("/{id}")
    public ResponseEntity detalharMedicor (@PathVariable Long id){
